...
import numpy as np
from common_bio.amino_acid import sequences_to_fasta
from common_bio.blast import get_local_blast_results, update_sequences_with_blast_results
...
class LocalBlastSummary(BlastSummary):
    ...
    def run_blast(self):
        print("Running Local Blast thread for step {}".format(self.global_step))
